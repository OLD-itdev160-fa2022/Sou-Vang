...
var data = [
    {
        ...
        user: 'Sou',
        message: "Hey Jake. Can I your borrow speakers?"
    },
    {
        type: messageType.in,
        user: 'Jake',
        message: "Sure. You can grab it today if you want."
    },
    {
        type: messageType.out,
        user: 'Sou',
        message: "Thanks! I'll be there in a bit."
    }
];
...
// Load seed data from data array about (Optional)
